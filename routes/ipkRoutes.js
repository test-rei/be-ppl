...
import { getAllIPK, getIPKById, getAllIPKCalculate, getIPKByIdCalculate, createIPK, updateIPK, deleteIPK } from "../controllers/ipkController.js";
...
router.get("/ipkc/:id", getIPKByIdCalculate);
